...
class API(ModelView):
    ...
    def __init__(self, session, model, exclude_columns=None,
        ...
        *not* be present in the JSON representation of the model provided in
        ...
        self.postprocessors['PATCH_SINGLE'] = list(set(self.postprocessors['PUT_SINGLE'] + self.postprocessors['PATCH_SINGLE']))
        self.preprocessors['PATCH_SINGLE'] = list(set(self.preprocessors['PUT_SINGLE'] + self.preprocessors['PATCH_SINGLE']))
        self.postprocessors['PATCH_MANY'] = list(set(self.postprocessors['PUT_MANY'] + self.postprocessors['PATCH_MANY']))
        self.preprocessors['PATCH_MANY'] = list(set(self.preprocessors['PUT_MANY'] + self.preprocessors['PATCH_MANY']))
